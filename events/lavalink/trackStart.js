module.exports = async(bot, player, track) => {
    ...
    bot.embed.setAuthor("Started Playing", "https://imgs.search.brave.com/oyv9NvW9g1RvUWiERhs3gpdQ4vo-tiqoXppHuAkDBIU/rs:fit:700:700:1/g:ce/aHR0cHM6Ly9tZWRp/YTAuZ2lwaHkuY29t/L21lZGlhL1NTOHph/TkZJYnd5amNQZGg4/VS9zb3VyY2UuZ2lm.gif")
    ...
    .setColor("BLUE")
    let msg = await channel.send({ embeds: [bot.embed] })
